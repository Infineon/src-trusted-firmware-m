                        ...
                        psa_storage_create_flags_t create_flags)
{
    ...
    /* Redirect OEM defined UIDs to platform function */
    if (is_tfm_ps_oem_uid(uid)) {
        return tfm_platform_ps_set(client_id, uid, data_length, create_flags);
    }
                        ...
                        size_t *p_data_length)
{
    ...
    /* Redirect OEM defined UIDs to platform function */
    if (is_tfm_ps_oem_uid(uid)) {
        return tfm_platform_ps_get(client_id, uid, data_offset, data_size,
                                   p_data_length);
    }
                             ...
                             struct psa_storage_info_t *p_info)
{
    ...
    /* Redirect OEM defined UIDs to platform function */
    if (is_tfm_ps_oem_uid(uid)) {
        return tfm_platform_ps_get_info(client_id, uid, p_info);
    }
...
psa_status_t tfm_ps_remove(int32_t client_id, psa_storage_uid_t uid)
{
    ...
    /* Redirect OEM defined UIDs to platform function */
    if (is_tfm_ps_oem_uid(uid)) {
        return tfm_platform_ps_remove(client_id, uid);
    }
