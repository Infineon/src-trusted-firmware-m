...
*
*******************************************************************************/
TFM_COVERITY_DEVIATE_LINE(MISRA_C_2012_Rule_8_6, "Depends on platform configuration")
...
*
*******************************************************************************/
TFM_COVERITY_DEVIATE_LINE(MISRA_C_2012_Rule_5_8, "Specified for cm4")
void Cy_Platform_Init(void)
{
     ...
     * Semaphore structure is allocated on sharable (between cores) non-secure memory. */
...
TFM_COVERITY_DEVIATE_LINE(MISRA_C_2012_Rule_5_8, "Platform specific initialization")
int32_t tfm_ns_platform_init (void)
{
    Cy_Platform_Init();
    cy_p64_confirm_image((FLASH_BASE_ADDRESS + NON_SECURE_IMAGE_OFFSET),
