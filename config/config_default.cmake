...
set(INSTALL_INTERFACE_INC_DIR           ${TFM_INSTALL_PATH}/interface/include CACHE PATH "Path to which to install TF-M interface/include files")
set(INSTALL_INTERFACE_SRC_DIR           ${TFM_INSTALL_PATH}/interface/src     CACHE PATH "Path to which to install TF-M interface/src files")
set(INSTALL_INTERFACE_LIB_DIR           ${TFM_INSTALL_PATH}/interface/lib     CACHE PATH "Path to which to install TF-M interface/lib files")
...
set(MBEDCRYPTO_PATCH_DIR                "${CMAKE_CURRENT_SOURCE_DIR}/lib/ext/mbedcrypto"
    CACHE PATH      "Path to folder with Mbed Crypto patches. Set empty string to skip patching.")
...
set(TFM_TEST_REPO_GIT_REMOTE            "https://git.trustedfirmware.org/TF-M/tf-m-tests.git" CACHE STRING "The URL (or path) to retrieve TFM tests from.")
set(TFM_TEST_REPO_APPLY_PATCHES         ON          CACHE BOOL      "Whether to apply patches for tf-m-tests repo.")
set(TFM_TEST_REPO_VERSION               "TF-Mv1.3.0"   CACHE STRING    "The version of tf-m-tests to use")
...
set(PSA_ARCH_TESTS_GIT_REMOTE           "https://github.com/ARM-software/psa-arch-tests.git" CACHE STRING "The URL (or path) to retrieve PSA arch tests from.")
