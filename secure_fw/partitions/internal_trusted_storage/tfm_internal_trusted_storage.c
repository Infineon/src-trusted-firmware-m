 ...
 */
#define ITS_BUF_SIZE (TFM_HAL_ITS_SECTORS_PER_BLOCK * TFM_HAL_ITS_SECTOR_SIZE)
#endif
...
#ifdef CY_POLICY_CONCEPT
    fs_cfg_its.max_file_size = ITS_UTILS_ALIGN(tfm_hal_its_max_asset_size(),
                                               ITS_FLASH_ALIGNMENT);
    fs_cfg_its.max_num_files = tfm_hal_its_max_num_assets() + 1;
#endif
...
#ifdef CY_POLICY_CONCEPT
    fs_cfg_ps.max_file_size = ITS_UTILS_ALIGN(tfm_hal_ps_max_asset_size()
                                              + PS_OBJECT_HEADER_SIZE,
                                              PS_FLASH_ALIGNMENT);
    fs_cfg_ps.max_num_files = tfm_hal_ps_max_num_assets() + 3;
#endif
#endif
