...
#endif  /* CY_POLICY_CONCEPT */

#if defined(ITS_MAX_ASSET_SIZE)
__WEAK uint32_t tfm_hal_its_max_asset_size(void)
{
    return ITS_MAX_ASSET_SIZE;
}
#endif

#if defined(ITS_NUM_ASSETS)
__WEAK uint32_t tfm_hal_its_max_num_assets(void)
{
    return ITS_NUM_ASSETS;
}
#endif
