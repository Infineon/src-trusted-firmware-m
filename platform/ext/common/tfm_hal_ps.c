...
#if defined(PS_MAX_ASSET_SIZE)
__WEAK uint32_t tfm_hal_ps_max_asset_size(void)
{
    return PS_MAX_ASSET_SIZE;
}
#endif

#if defined(PS_NUM_ASSETS)
__WEAK uint32_t tfm_hal_ps_max_num_assets(void)
{
    return PS_NUM_ASSETS;
}
#endif
