 ...
 *
 * PSA FF-M :
 * - The Secure Partition ID is a 32-bit signed integer.
 * - Secure Partition IDs must be positive.
 * - Negative values are reserved for client endpoints that originate in the NSPE
 */
#define INVALID_PARTITION_ID ((int32_t)0x80000000)
