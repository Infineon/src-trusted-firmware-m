...
*
*******************************************************************************/
TFM_COVERITY_DEVIATE_LINE(MISRA_C_2012_Rule_5_8, "PSoC Creator generated func")
...
void SystemCoreClockUpdate (void)
{
    ...
    if ((locHf0Clock > 0U) && (locHf0Clock <= CY_CLK_HF_MAX))
    {
        ...
        TFM_COVERITY_BLOCK(TFM_COVERITY_DEVIATE(cert_int31_c, "type cast is safe \
                                            because SystemCoreClock limits are checked") \
                           TFM_COVERITY_FP(cert_int30_c, "SystemCoreClock limits \
                                            are checked, wrap is impossible"))
